...
public class GoogleBooksClient {
    ...
    public ArrayList<Book> getBooks(String searchTerm){
		...
		try {
	        ...
	        //ArrayList<String> titlesList = GoogleBooksClient.getLinksFromJson(items);
    ...
    public ArrayList<Book> sortByMatchingStringTokens(ArrayList<Book> booksList, String searchTerm){
    ...
    public static Book fromJson(org.json.JSONObject jsonObject) {
		Book b = new Book();
        try {
            b.setTitle(jsonObject.getJSONObject("volumeInfo").getString("title"));
        } catch (Exception e) {
        	b.setTitle("Not found");
        } try {
        	b.setPublisher(jsonObject.getJSONObject("volumeInfo").getString("publisher"));
        } catch (Exception e) {
        	b.setPublisher("Not found");
        } try {
        	b.setPublishedDate(jsonObject.getJSONObject("volumeInfo").getString("publishedDate"));
        } catch (Exception e) {
        	b.setPublishedDate("Not found");
        } try {
        	b.setPageCount(jsonObject.getJSONObject("volumeInfo").getInt("pageCount"));
        } catch (Exception e) {
        	b.setPageCount(-1);
        } try {
        	b.setLink(jsonObject.getJSONObject("volumeInfo").getString("previewLink"));
        } catch (Exception e) {
        	b.setLink("Not found");
        } try {
        	ArrayList<String> authList = new ArrayList<String>();
            JSONArray authorsJsonArray = jsonObject.getJSONObject("volumeInfo").getJSONArray("authors");
    ...
    /*public static void main(String[] args) {
        ...
        ArrayList<Book> booksList = client.getBooks("The lord of the rings");
